...
class BlogPost(models.Model):
    ...
    photo = models.ImageField(upload_to='blog/', null=True, blank=True,
                              help_text="برای نمایش بهتر در سایت، باید نسبت ابعاد تصویر بین ۰.۸ تا ۱.۲ باشد.",
                              validators=[validate_image_size,validate_square_image])
    ...
    text = RichTextUploadingField(null=False, blank=False)
